...
void init_new_network_upload(string &url) {
 
}

promise<string &> start_network_upload(nbtp_chunk *chunk) {
    // 在main函数中，应该已经curl_global_init完毕了。
}
=======
class full_upload_task
{
...
>>>>>>> 3f4c092a5568e91c51396096272732c197eb182d
